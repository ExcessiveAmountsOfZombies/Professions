...
public final class FabricGateReloadListener implements PreparableReloadListener {

    public static final Identifier ID = Identifier.fromNamespaceAndPath(ProfessionsCommon.MOD_ID, "gates");
