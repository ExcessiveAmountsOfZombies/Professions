...
import com.epherical.professions.client.gui.components.OccupationList;
...
public class OccupationMenuScreen extends Screen {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "occupation/occupation_menu");
