...
final class SmithingActionProvider implements DataProvider {
    ...
    SmithingActionProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
