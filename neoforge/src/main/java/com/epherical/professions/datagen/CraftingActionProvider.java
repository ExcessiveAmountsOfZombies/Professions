...
final class CraftingActionProvider implements DataProvider {
    ...
    CraftingActionProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
