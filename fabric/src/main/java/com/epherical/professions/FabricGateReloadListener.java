...
public final class FabricGateReloadListener implements IdentifiableResourceReloadListener {

    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(ProfessionsCommon.MOD_ID, "gates");

    private final GateLoad3 delegate;
    private final HolderLookup.Provider registries;

    public FabricGateReloadListener(GateLoad3 delegate, HolderLookup.Provider registries) {
