...
public class Profession {
    ...
    public ProfessionSerializer<Profession> getSerializer() {
        return ProfessionSerializer.DEFAULT_PROFESSION.get();
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<ProfessionSerializer<?>> implements ProfessionSerializer<Profession> {
        ...
        public JsonElement serialize(Profession src, Type typeOfSrc, JsonSerializationContext context) {
            ...
            object.addProperty("type", RegistryConstants.PROFESSION_SERIALIZER.getKey(ProfessionSerializer.DEFAULT_PROFESSION.get()).toString());
