...
public class CommonConfig {
    ...
    public CommonConfig(boolean devEnvironment, String configName, File configDir) {
    ...
    protected void parseConfig(ConfigurationNode node) {
        ...
        headerBorders = TextColor.parseColor(node.node("colors").node("headerBoarders").getString(headerBorders.serialize())).getOrThrow();
        descriptors = TextColor.parseColor(node.node("colors").node("descriptors").getString(descriptors.serialize())).getOrThrow();
        variables = TextColor.parseColor(node.node("colors").node("variables").getString(variables.serialize())).getOrThrow();
        errors = TextColor.parseColor(node.node("colors").node("errors").getString(errors.serialize())).getOrThrow();
        success = TextColor.parseColor(node.node("colors").node("success").getString(success.serialize())).getOrThrow();
        money = TextColor.parseColor(node.node("colors").node("money").getString(money.serialize())).getOrThrow();
        experience = TextColor.parseColor(node.node("colors").node("exp").getString(experience.serialize())).getOrThrow();
        noMoreRewards = TextColor.parseColor(node.node("colors").node("noMoreRewards").getString(noMoreRewards.serialize())).getOrThrow();
        moreRewards = TextColor.parseColor(node.node("colors").node("moreRewards").getString(moreRewards.serialize())).getOrThrow();
