...
import com.epherical.professions.datagen.gate.GateProvider;
...
public final class ProfessionDataGeneration {
    ...
    public static void onGatherData(GatherDataEvent.Client event) {
        ...
        event.getGenerator().addProvider(true, new MiningPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new LoggingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new FarmingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new FishingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new HuntingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new EnchantingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new CraftingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new SmithingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new BuildingPerkProvider(out, professionsProvider.getRegistryProvider()));
        event.getGenerator().addProvider(true, new LoggingActionProvider(out, professionsProvider.getRegistryProvider()));
