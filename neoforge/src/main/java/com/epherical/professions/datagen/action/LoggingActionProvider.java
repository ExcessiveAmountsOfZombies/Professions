...
public final class LoggingActionProvider implements DataProvider {
    ...
    public LoggingActionProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
