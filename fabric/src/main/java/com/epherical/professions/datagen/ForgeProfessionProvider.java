    ...
    public void run(HashCache cache) throws IOException {
        ...
        ProfessionBuilder hunting = ProfessionBuilder.profession(
                ...
                .addAction(EXPLORE_BIOME, ExploreBiomeAction.explore()
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_overworld")))
                        .reward(moneyReward(3))
                        .reward(expReward(6)))
                .addAction(EXPLORE_BIOME, ExploreBiomeAction.explore()
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_hot/nether")))
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_cold/nether")))
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_dense/nether")))
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_nether")))
                        .reward(moneyReward(4))
                        .reward(expReward(8)))
                .addAction(EXPLORE_BIOME, ExploreBiomeAction.explore()
                        .biome(TagKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("forge:is_end")))
                        .reward(moneyReward(5))
