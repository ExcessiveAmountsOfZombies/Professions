...
final class BuildingActionProvider implements DataProvider {
    ...
    BuildingActionProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
